...
export const App = () => {
	const [articalState, setArticalState] = useState<ArticleStateType>(defaultArticleState);
	return (
		<main
			...
			<ArticleParamsForm stateArticleParamsForm={articalState} setParamsFormState={setArticalState} articalParamsFormTitle="Задайте параметры" as="h2" />
			<Article />
		</main>
	);
};